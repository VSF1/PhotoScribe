...
class OllamaWorker(QThread):
    ...
    def _build_prompt(self, face_tags=None, photo=None):
        ...
        if (ctx or photo_location or photo_date) and 'location_ground_truth' in self.prompt_skills:
    ...
    def _write_sidecar(raw_path: Path, metadata: PhotoMetadata, adobe_naming=False,
        ...
        if append_keywords:
            ...
            if xmp_path.exists():
                ...
                clear_args = [exiftool, "-overwrite_original", "-tagsfromfile", str(raw_path), "-XMP-dc:Subject=",
                     "-XMP-lr:HierarchicalSubject=", "-o", str(xmp_path)]
